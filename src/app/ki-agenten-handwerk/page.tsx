...
export const metadata: Metadata = {
  title: "KI-Agenten fuer Handwerksbetriebe",
  description:
    "KI-Agenten fuer Handwerksbetriebe: Anfragen besser bearbeiten, Wissen schneller nutzen und interne Prozesse entlasten.",
  ...
  return (
    <main className="min-h-screen bg-[var(--surface-0)] px-6 py-24 text-[var(--ink-1)]">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mt-4 text-5xl font-semibold tracking-[-0.04em]">KI-Agenten fuer Handwerksbetriebe</h1>
        <p className="mt-8 text-lg leading-8 text-[var(--muted)]">
          ...
          Hessen entsteht so mehr Entlastung im Tagesgeschaeft.
        </p>
      </div>
    </main>
  );
