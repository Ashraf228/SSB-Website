...
export const processSteps = [
  {
    step: "01",
    title: "Analyse",
    text: "Wir schauen gemeinsam auf Ziele, Engpässe, Prozesse und Potenziale, damit die Lösung nicht nur modern aussieht, sondern im Alltag wirklich funktioniert.",
  },
  {
    step: "02",
    title: "Strategie",
    text: "Auf Basis der Analyse entsteht ein klarer Plan für Website, KI-Abläufe, Chatbot oder Automatisierung – priorisiert und nachvollziehbar.",
  },
  {
    step: "03",
    title: "Umsetzung",
    text: "Die wichtigsten Maßnahmen werden strukturiert umgesetzt, technisch sauber aufgebaut und auf dein Unternehmen zugeschnitten.",
  },
  {
    step: "04",
    title: "Optimierung",
    text: "Nach dem Livegang wird verfeinert, gemessen und dort nachgeschärft, wo mehr Klarheit, mehr Effizienz oder mehr Anfragen möglich sind.",
  },
  {
    step: "05",
    title: "Langfristige Begleitung",
    text: "Wenn gewünscht, begleite ich die Entwicklung weiter, damit Systeme, Inhalte und Prozesse mit deinem Unternehmen mitwachsen.",
  },
];
...
export const faqItems = [
  ...
  },
  {
    ...
    a: "Ja, abhängig vom Setup. Datenflüsse, Zugriffe und Speicherorte müssen sauber geplant werden, damit Datenschutz und praktische Nutzbarkeit zusammenpassen.",
  },
  {
    q: "Wie schnell kann ein Projekt starten?",
    a: "In der Regel direkt nach dem Erstgespräch. Kleine Websites oder klar umrissene Automationen lassen sich oft sehr zügig anstoßen.",
  },
  {
    q: "Was kostet das?",
    a: "Das hängt vom Umfang ab. Im Gespräch klären wir Ziele, Aufwand und sinnvolle Prioritäten, damit du eine realistische Einschätzung bekommst.",
  },
];
...
export const founderHighlights = [
  {
    ...
    desc: "Nicht nur einzelne Maßnahmen, sondern digitale Strukturen, die im Alltag funktionieren und dein Unternehmen langfristig entlasten.",
  },
  {
    title: "Fokus auf Effizienz",
    desc: "Mehr Struktur, weniger Aufwand und klarere Abläufe – damit Zeit gespart und operative Reibung reduziert wird.",
  },
  {
    title: "Langfristige Partnerschaft",
    desc: "Ziel ist nicht ein einmaliger Sprint, sondern eine digitale Entwicklung, die mit dem Unternehmen mitwachsen kann.",
  },
];
